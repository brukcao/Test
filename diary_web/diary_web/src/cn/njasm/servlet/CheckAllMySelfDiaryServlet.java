 ...
 */
@WebServlet(name = "checkAllMySelfDiaryServlet", urlPatterns = { "/checkAllMySelfDiaryServlet" })
public class CheckAllMySelfDiaryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int u_id = Integer.parseInt(request.getParameter("u_id"));
		 ...
		 List<Diary> ll = null;
		 try {
			ll  = ds.checkAllMySelfDiary(u_id);
		} catch (Exception e) {
